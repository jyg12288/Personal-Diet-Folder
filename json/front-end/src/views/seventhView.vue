    ...
    <v-app>
        <v-container>
            ...
            <div style="text-align: center;padding-top: 150px;">
                <b><p style="font-size: 25px; padding-bottom: 20px;">선호하지 않는 식단이 있나요?</p></b>
                ...
                <input type="checkbox" id="달걀 및 동물성 제품" value="달걀 및 동물성 제품" v-model="user.not_preference" > <label for="달걀 및 동물성 제품"  @click="Modify5" style="padding-top:40px;">달걀 및 <br/> 동물성 제품</label>
